...
(function($){
	...
	$.fn.tablepage = function(oObj, dCountOfPage) {
		...
		function change_page_content()
		{
			...
			sPageStr = "<table class='table-filter'><tr><td>&nbsp;第&nbsp;</td>";
			...
			for (var i = 1; i <= dCount; i += dCountOfPage)
			{
				...
				{
					//sPageStr += "<td valign='top'><table style='><tr><th>" + (dPageIndex++) + "</th></tr></table></td>";
					sPageStr += "<td valign='top' id='filter-active'><table><tr><td>" + (dPageIndex++) + "</td></tr></table></td>";
				}
				else
				{
					...
					sPageStr += "<td valign='top'><table><tr><td>" + (dPageIndex++) + "</td></tr></table></td>";
				}
			}
			
			sPageStr += "<td>&nbsp;頁&nbsp;</td></table>";
